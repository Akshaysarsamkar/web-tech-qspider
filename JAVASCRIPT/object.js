...
// // call(),apply(),bind() -----> to execute perticular function for multiple object even the function is present in the different object 

let fullname = function(role,location){
    console.log(`Hello I Am ${this.fname} ${this.lname} and i am working as ${role} in ${location}`)
}
...
// // emp1.fullname.call(emp1,'UI Developer','PUNE')
// // emp1.fullname.call(emp2,'Front-End eng','Mumbai')

// //1. call Method : used to call a function for multiple object
//     //  syntax :- function.call(object_name,parameter)

fullname.call(emp1,'Tech support','bng');
fullname.call(emp2,'Fullstack','Beedc')


// // 2.apply : same as called ()--> function argmenet passed as array
fullname.apply(emp1,['Test eng','Noida']);
fullname.call(emp2,['Back end','bng'])
fullname.call(emp3,['Back end','bng'])

// //3.bind() : same as call() and apply() -> copy function and return new function argument passed as normal
let res = fullname.bind(emp1,'Data Scince','bng');
res();

let res2 = fullname.bind(emp3,'Bussine Analyst','Gurugram');
res2();
